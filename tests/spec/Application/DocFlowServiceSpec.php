...
{
    function let(DomainRegistry $domainRegistry, UserRepository $userRepository, DocumentRepository $documentRepository, NumberGenerator $numberGenerator)
    {
        ...
        $this->beConstructedWith(DocFlowService::ENV_PROD, $domainRegistry, $numberGenerator);
    }
    function it_is_initializable()
    {
        $this->shouldHaveType(DocFlowService::class);
    }
    function it_uses_DemoNumberGenerator_when_running_on_demo(DomainRegistry $domainRegistry, UserRepository $userRepository, NumberGenerator $numberGenerator)
    {
        $this->beConstructedWith(DocFlowService::ENV_DEMO, $domainRegistry, $numberGenerator);
